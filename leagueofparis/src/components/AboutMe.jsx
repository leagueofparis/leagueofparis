...
const AboutMe = () => (
	<div className="bg-base-200 rounded-lg shadow-md p-6 w-full max-w-[667px] flex flex-col items-center">
		...
		<p className="text-base text-center">
			Hi there :) My name is Paris and I am new to streaming! If you are reading
			this, thanks for checking out my page. I hope that you follow and say
			hello during my next stream!
		</p>
		<div className="mt-4 text-base w-full">
			...
			<ul className="list-disc list-inside ml-4">
				...
				<li>
					<span className="font-semibold">Hobbies:</span> I like to read and do
					DIY crafts
				</li>
			</ul>
			...
			<ul className="list-disc list-inside ml-4">
				<li>
					<span className="font-semibold">What Games?</span> I only play League
					(send help)
				</li>
				<li>
					<span className="font-semibold">Do You Duo?</span> I am currently
					trying to SoloQ ranked but was generously gifted an alt account where
					I will begin duoing soon!
				</li>
				<li>
